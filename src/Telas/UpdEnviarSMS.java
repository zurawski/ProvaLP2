...
public class UpdEnviarSMS extends javax.swing.JFrame 
{
    ...
    /**
     * Creates new form UpdEnviarSMS
     */
    public UpdEnviarSMS(String usu, String sen) 
    {
        initComponents();
        this.usuario = usu;
        this.senha = sen;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Informar o DDD Ex.: 5199999999");
        ...
        jMenuItem6.setText("Modelo de Mensagem");
        ...
        jMenuItem7.setText("Inserir Contato");
        ...
        jMenuItem8.setText("Alterar Contato");
        jMenu3.add(jMenuItem8);

        jMenuItem9.setText("Deletar Contato");
    ...
    private void btn_EnviarSMSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EnviarSMSActionPerformed
        ...
        try {
            ...
            SMS_Individual SMS = new SMS_Individual("zurawski","78998",Numero,Mensagem);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        try {
            SMS_ConsultaCredito credito = new SMS_ConsultaCredito("zurawski","78998");
        } catch (Exception ex) {
            Logger.getLogger(UpdEnviarSMS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    JOptionPane.showMessageDialog(this,Login.getLogin());   
    ...
    public static void main(final String usu, final String sen) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdEnviarSMS(usu,sen).setVisible(true);
            }
        });
    }
