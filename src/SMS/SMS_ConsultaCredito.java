 ...
 * @author Zurawski
 */
public class SMS_ConsultaCredito 
{
    ...
    public SMS_ConsultaCredito(String Usuario, String Senha) throws Exception
    {
        super();
        this.User = Usuario;
        this.Password = Senha;
        SMS_ConsultaCredito.ConsultaCredito(Usuario,Senha);
